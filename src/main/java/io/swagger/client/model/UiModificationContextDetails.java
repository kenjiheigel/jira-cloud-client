...
public class UiModificationContextDetails {
  ...
  **/
   ...
   * @return issueTypeId
  **/
  @Schema(required = true, description = "The issue type ID of the context.")
   ...
   * @return projectId
  **/
  @Schema(required = true, description = "The project ID of the context.")
   ...
   * @return viewType
  **/
  @Schema(required = true, description = "The view type of the context. Only `GIC` (Global Issue Create) is supported.")
